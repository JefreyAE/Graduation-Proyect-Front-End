        ...
        var plantillaAuctionOptions = `
            <div id="options">
                ...
                <label class="form-label" for="auction_commission">Comisión de la subasta (Porcentaje): (Ejem: 5)</label>
                                    <div><input class="form-control" id="auction_commission" name="auction_commission" type="text"></div>
                                    </div>
                <div class="mb-3">
                <label class="form-label" for="auction_name">Nombre de la subasta:</label>
                                    <div><input class="form-control" id="auction_name" name="auction_name" type="text"></div>
                                    </div>
            </div>    
